...
#immutable_var[0] = 8
print ('"immutable_var[0] = 8" - Изменение внести не возможно, так как данные внесенные в кортеж является постоянными,за исключением случаев когда в кортеж внесен список')
